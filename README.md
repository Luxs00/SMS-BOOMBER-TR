...
7- Bu token'ı *discord-selfbot-luxsms.py*'dn *token* kısmına yazınız. (str olarak)<br>
...
4- Bu id'yi *discord-selfbot-Luxsms.py*'de *chat_id* kısmına yazınız. (int olarak)<br><br>
